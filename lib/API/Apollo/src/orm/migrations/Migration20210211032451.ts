...
export class Migration20210211032451 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "user" ("id" varchar(255) not null, "first_name" varchar(255) not null, "last_name" varchar(255) not null, "email" varchar(255) not null, "date_of_birth" timestamptz(0) not null, "city" varchar(255) not null, "province" varchar(255) not null, "country" varchar(255) not null, "stripe_customer_id" varchar(255) not null, "stripe_account_id" varchar(255) not null, "created" date not null, "modified" jsonb not null, "status" bool not null);');
