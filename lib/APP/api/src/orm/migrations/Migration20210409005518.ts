...
export class Migration20210409005518 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "booking" ("listing_id" varchar(255) not null, "buyer_id" varchar(255) not null, "id" varchar(255) not null);');
